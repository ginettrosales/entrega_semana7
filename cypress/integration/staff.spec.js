...
// Escenarios A-Priori
    ...
    it('E03-A-Priori Invitar a un usuario', function() { 
    ...
    it('E04-A-Priori Modificar datos generales metadatos', function() { 
    ...
    it('E05-A-Priori Modificar datos generales Titulo facebook', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
    ...
    it('E06-A-Priori Modificar datos generales Descripción facebook', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting-last > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
    ...
    it('E07-A-Priori Modificar datos generales Titulo twitter', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
    ...
    it('E08-A-Priori Modificar datos generales Descripción twitter', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
...
// Escenarios Pseudo
    ...
    it('E01-Pseudo Modificar datos del perfil', function() { 
    ...
    it('E02-Pseudo Modificar datos del perfil', function() { 
    ...
    it('E03-Pseudo Invitar a un usuario', function() { 
    ...
    it('E04-Pseudo Modificar datos generales metadatos', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting-first > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#metaDescription').clear({force: true});
    ...
    it('E05-Pseudo Modificar datos generales Titulo facebook', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting-last > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#ogTitle').clear({force: true});
    ...
    it('E06-Pseudo Modificar datos generales Descripción facebook', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting-last > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#ogDescription').clear({force: true});
    ...
    it('E07-Pseudo Modificar datos generales Titulo twitter', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#twitterTitle').clear({force: true});
    ...
    it('E08-Pseudo Modificar datos generales Descripción twitter', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#twitterDescription').clear({force: true});
...
// Escenarios Faker
    ...
    it('E01-Faker Modificar datos del perfil', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/staff/ghost');
        cy.get('#user-location').clear({force: true});
    ...
    it('E02-Faker Modificar datos del perfil', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/staff/ghost');
        cy.get('#user-website').clear({force: true});
    ...
    it('E03-Faker Invitar a un usuario', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/staff');
        cy.get("button.gh-btn.gh-btn-green").click();
        cy.get('#new-user-email').clear({force: true});
    ...
    it('E04-Faker Modificar datos generales metadatos', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting-first > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#metaDescription').clear({force: true});
    ...
    it('E05-Faker Modificar datos generales Titulo facebook', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting-last > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#ogTitle').clear({force: true});
    ...
    it('E06-Faker Modificar datos generales Descripción facebook', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting-last > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#ogDescription').clear({force: true});
    ...
    it('E07-Faker Modificar datos generales Titulo twitter', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#twitterTitle').clear({force: true});
    ...
    it('E08-Faker Modificar datos generales Descripción twitter', function() { 
        cy.visit(Cypress.env('baseUrl')+'ghost/#/settings/general/');
        cy.get(".gh-setting > .flex > .gh-setting-action > .gh-btn > span").click({force:true}); 
        cy.get('#twitterDescription').clear({force: true});
